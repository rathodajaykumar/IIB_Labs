...
public class Excelreadebyjcn_MF_JavaCompute extends MbJavaComputeNode {
...
public void parseXLSX(InputStream fis, MbMessage outMessage){
		...
		try {
			...
			// To remove this error you need to add jars in (goto java perspective-->goto your project-->Right-click on the Referenced Libraries->Build Path ->Add External JARs -> select all the above jar files -> Apply and close.)
